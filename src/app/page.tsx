  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50">
      <nav className="flex items-center justify-between p-6 max-w-7xl mx-auto w-full">
        <div className="text-xl font-bold text-slate-900">SaaS Project</div>
      ...
      <section className="bg-white py-20 border-t border-slate-200">
        <div className="max-w-5xl mx-auto px-6 grid md:grid-cols-2 gap-8">
          ...
          <div className="p-8 border-2 border-slate-900 rounded-2xl relative">
            ...
            <ul className="mt-6 space-y-3 text-slate-900 font-medium">
      ...
      <footer className="py-8 text-center text-slate-500 text-sm">
        © {new Date().getFullYear()} SaaS Project. All rights reserved.
      </footer>
    </div>
  );
}